(function(){
    //Using IIFE in order to avoid global namespaces
    ...
    function main(){ //main function
        getData(url, function(data){       //data handling
            ...
            console.log("JSON document was successfully obtained!"); //successful request
        }, function () {                                           //error handling callback
            console.log("Unable to get the document!");
        });
    }

    window.addEventListener('load', main, false);  //final event handler. The script above will run once the page is loaded.
